...
public class Parameters {
	...
	public static int selectionTournamentSize = 5;
	public static int replaceTournamentSize = 5;
	public static int maxEvaluations = 20000;
	
	// Parameters for mutation 
	// Rate = probability of changing a gene
	// Change = the maximum +/- adjustment to the gene value
	public static double mutateRate = 0.25; // mutation rate for mutation operator
	public static double mutateChange = 0.75; // delta change for mutation operator
